import { preloadProducts, preloadProductDetails, preloadSneakers, preloadSneakerPurchase, preloadApparel, preloadApparelPurchase, preloadAudio } from "@/lib/preloadRoutes";
