import { preloadProducts, preloadProductDetails, preloadSneakers, preloadSneakerPurchase, preloadApparel, preloadApparelPurchase, preloadAudio, preloadElectronics, preloadElectronicsPurchase } from "@/lib/preloadRoutes";
...
const Audio = lazy(preloadAudio);
const Electronics = lazy(preloadElectronics);
const ElectronicsPurchase = lazy(preloadElectronicsPurchase);
                ...
                <ErrorBoundary>
                  ...
                  <Suspense fallback={<PageLoader />}>
                    ...
                    <Routes>
                      ...
                      <Route path="/fones" element={<Audio />} />
                      <Route path="/eletronicos" element={<Electronics />} />
                      <Route path="/eletronicos/:id" element={<ElectronicsPurchase />} />
