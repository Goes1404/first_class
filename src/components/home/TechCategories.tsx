  ...
  return (
    <section className="pt-6" aria-label="Categorias">
      <div className="mx-auto max-w-5xl px-4">
        <Stagger as="ul" gap={0.05} className="flex gap-5 sm:gap-8 overflow-x-auto pb-1 sm:justify-center [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {items.map(({ label, to, Icon }) => (
            <StaggerItem as="li" kind="scale" key={label} className="shrink-0">
